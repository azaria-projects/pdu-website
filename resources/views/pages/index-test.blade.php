    ...
    <div class="landing-contents">
        ...
        <div class="app-content-header pb-0">
            <div class="container-fluid">
                <div class="banner-container px-2 py-2">
        ...
        <div class="app-content">
            <div class="container-fluid d-flex flex-column">
                {{-- contents --}}
                <div id="web-contents" class="contents">
                ...
                <div id="company-statistics" class="contents row">
                    <div class="d-flex flex-column">
                        ...
                        <div class="row">
                            <div class="col-3 shaded d-flex flex-column align-items-center">
                ...
                <div id="partners-testimonies" class="contents row">
                    <div class="d-flex flex-column">
