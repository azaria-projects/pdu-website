        ...
        <div class="row mx-0">
            <div class="col-12 col-sm-12 col-md-6">
                <div class="d-flex flex-column mb-3">
                    <label for="add-icon-select" class="form-label"><i class="ti ti-favicon me-1"></i> service icon <span class="required">*</span> </label>
            ...
            <div class="col-12 col-sm-12 col-md-6">
                <div class="mb-3">
                    <label for="add-name" class="form-label d-flex align-items-center gap-1"><i class="ti ti-tag-starred"></i> service name <span class="required">*</span></label>
