    ...
    <div class="row justify-content-between align-items-center mx-0 p-4 pb-0">
        <div class="col-12 col-md-4">
            @include('components.admin.page-header', [
                'icon'      => 'ti-home',
                'header'    => 'Files',
                'subheader' => 'display all uploaded files data',
            ])
        </div>
        ...
        <div class="row mx-0">
            <div class="col-12 col-sm-12 col-md-6 col-lg-4">
                <div class="mb-3">
                    ...
                    <input id="filter-search" name="filter-search" type="text" class="form-control" placeholder="ex: mudlogging-photo">
                </div>
            </div>
        </div>
                ...
                <table id="table-datatable" class="table">
                    <thead>
                        <tr class="text-center">
                            ...
                            <th id="size"        class="text-center">Size</th>
                            <th id="type"        class="text-center">Type</th>
                            <th id="path"        class="text-center">Link</th>
                            <th id="extension"   class="text-center">Extension</th>
